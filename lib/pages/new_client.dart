        ...
        body: SizedBox(
          ...
          child: Column(
            children: [
              ...
              ConstrainedBox(
                constraints: BoxConstraints(maxHeight: 40),
                child: LoginInput(label: "Mother's Name", icon: Icons.person),
              ),
              SizedBox(height: 4),
              ConstrainedBox(
                constraints: BoxConstraints(maxHeight: 40),
                child: LoginInput(label: "Father's Name", icon: Icons.person),
              ),
              SizedBox(height: 4),
              ConstrainedBox(
                constraints: BoxConstraints(maxHeight: 40),
                child:
                    LoginInput(label: "Birthday", icon: Icons.calendar_today),
              ),
              SizedBox(height: 4),
              ConstrainedBox(
                constraints: BoxConstraints(maxHeight: 40),
                child: LoginInput(label: "Address", icon: Icons.location_on),
              ),
              SizedBox(height: 20),
              Row(
